...
<body>
	<div class="container">
		...
		<form method="post" action="/lesson06/ex01/add_user">
			...
			<%--AJAX 통신일 때는 반드시 button타입으로 지정한다. --%>
		...
		*/
		...
		$("#addBtn").on("click", function(){
			...
			$.ajax({
				// request
				type:"POST" 
				, url:"/lesson06/ex01/add_user"	//url은 반드시 소문자로 해야한다
				, data:{"name":name, "yyyymmdd":yyyymmdd, "email":email, "introduce":introduce}	// requestParameter이름 :
